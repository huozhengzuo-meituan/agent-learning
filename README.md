...
- reference/：可打印的术语与速查资料。
- assets/：共享样式与练习组件。
- learning-records/：已展示的理解和已确认的基础，不把已阅读记成已掌握。

## 继续学习

下次可以说：“以 /Users/huozhengzuo/study/agent-learning 为工作区继续教学，先读取 MISSION.md、NOTES.md 和 learning-records。”

练习答案不会自动上传或写入学习记录。将答案与理由贴回对话，教师会给反馈，并据此安排下一课。
